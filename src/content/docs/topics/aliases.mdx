---
title: Aliases
description: Define your own K9s command aliases and autosuggestions.
---
...
| Key                                            | Description                              |
| ---------------------------------------------- | ---------------------------------------- |
| <kbd>↑</kbd> <kbd>↓</kbd>                       | Navigate up or down thru the suggestions |
| <kbd>Ctrl</kbd>+<kbd>W</kbd> or <kbd>Ctrl</kbd>+<kbd>U</kbd> | Clear out the command                    |
| <kbd>Tab</kbd>, <kbd>Ctrl</kbd>+<kbd>F</kbd>, or <kbd>→</kbd> | Accept the suggestion                    |
...
<Aside type="caution">
  As of v0.30.0 this file must have a `.yaml` extension. Also note the file name
  is pluralized as well as the top section of the file aka `aliases`.
</Aside>
