---
title: HotKeys
description: Configure K9s hotkeys for quick navigation to your favorite resources.
---
...
You can scope hotkeys to a specific cluster/context by defining them in `$XDG_DATA_HOME/k9s/clusters/clusterX/contextY/hotkeys.yaml`.

<Aside type="caution">
  This configuration might change in future releases!
</Aside>
