---
title: Skins
description: Style K9s with your own look and feel using skin files.
---

import { Aside } from "@astrojs/starlight/components";
import { Image } from "astro:assets";
import ColorSwatches from "../../../components/ColorSwatches.astro";
import dracula from "../../../assets/skins/dracula.png";
...
<Image src={dracula} alt="K9s Dracula skin" loading="lazy" />

<Aside type="caution">
  Changes to the skin file layout will occur as more features are added, so
  tread accordingly!
</Aside>
...
Colors below can be used by name in your skin files. They are grouped by hue — find a shade you like and copy its name into your skin YAML.
